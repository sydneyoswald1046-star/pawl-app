 ...
 *
 * Both render a simple "you can return to the PAWL app" page. The actual
...
export const stripeConnectReturn = onRequest(
  ...
  async (req, res) => {
    ...
    const body = isRefresh
      ? 'Your Stripe setup link expired or was cancelled. Return to the PAWL app and tap “Connect Stripe” again.'
      : 'You can close this tab and return to the PAWL app. Online payment links will start working on new invoices once Stripe finishes verifying your account.';
